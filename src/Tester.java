...
//		//---------------
		...
		NeuralNetwork xor_nn = new NeuralNetwork("2, 3, 1", ActivationTypes.SIGMOID, ActivationTypes.SIGMOID);
		
		NeuralNetSerializer.SerializeNeuralNet(xor_nn, "C:\\Users\\regan\\Desktop\\TEST_FILE.txt");
